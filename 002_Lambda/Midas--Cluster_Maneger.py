...
def lambda_handler(event, context):
    try:
        ...
        if data_of_instance.get('SG', None) == None:
            return 0
        ...
        sql_data = {
            ...
            "Layer_Name" : data_of_instance.get('SG', None),
            "State" : data_of_instance.get('State', None),
            "Region" : region,
            "Stack" : map_[region],
        ...
        give_info_2_slack(text = "System Instance Status Change! Couldnt Managed! \n Exception :"+str(e), key_value_data= event, LOG_TYPE = "system_log", stack = "sg.bet.data", state = 'dev')            
        give_info_2_slack(text = "System Instance Status Change! Couldnt Managed! \n Exception :"+str(e), key_value_data= event, LOG_TYPE = "system_log", stack = "sg.bet.data", state = 'test')            
        give_info_2_slack(text = "System Instance Status Change! Couldnt Managed! \n Exception :"+str(e), key_value_data= event, LOG_TYPE = "system_log", stack = "sg.bet.data", state = 'prod')            
